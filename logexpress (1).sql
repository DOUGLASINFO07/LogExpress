...
--
-- Máquina: localhost
-- Data de Criação: 24-Jun-2014 às 22:02
...
INSERT DELAYED IGNORE INTO `clientes` (`Codigo`, `NOme`, `Fantasia`, `CNPJ`, `InscEstadual`, `Telefone1`, `Telefone2`, `Fax`, `Email`, `Site`, `Endereco`, `Numero`, `Bairro`, `Cidade`, `Estado`, `CEP`, `Observacoes`) VALUES
...
INSERT DELAYED IGNORE INTO `controlecombustivel` (`Codigo`, `DataAbastecimento`, `Kilometro`, `TipoCombustivel`, `Litros`, `TotalPago`, `Observacao`, `CodVeiculo`, `CodFornecedor`) VALUES
...
INSERT DELAYED IGNORE INTO `destinatario` (`Codigo`, `Nome`, `Fantasia`, `CNPJ`, `InscEstadual`, `Telefone1`, `Telefone2`, `Fax`, `Email`, `Site`, `Endereco`, `Numero`, `Bairro`, `Cidade`, `Estado`, `CEP`, `Observacoes`) VALUES
...
INSERT DELAYED IGNORE INTO `fornecedor` (`Codigo`, `Nome`, `Fantasia`, `CNPJ`, `InscEstadual`, `Telefone1`, `Telefone2`, `Fax`, `Email`, `Site`, `Endereco`, `Numero`, `Bairro`, `Cidade`, `Estado`, `CEP`, `Observacoes`) VALUES
...
INSERT DELAYED IGNORE INTO `funcionario` (`idFuncionario`, `Nome`, `CPF`, `RG`, `DataNascimento`, `CatHabilitacao`, `CNH`, `PIS`, `TelResidencial`, `Celular`, `Endereco`, `NumEnd`, `Bairro`, `Cidade`, `Estado`, `CEP`, `EstadoCivil`, `Sexo`, `Observacao`) VALUES
...
INSERT DELAYED IGNORE INTO `login` (`codigo`, `nome`, `senha`) VALUES
(1, 'logexpress', '123');
...
INSERT DELAYED IGNORE INTO `manutencaopneus` (`Codigo`, `DataEntrada`, `Reparo1`, `Reparo2`, `Reparo3`, `Orcamento`, `DataSaida`, `Observacao`, `CodVeiculo`, `Codfornecedor`) VALUES
...
INSERT DELAYED IGNORE INTO `manutencaoveiculo` (`Codigo`, `DataEntrada`, `reparo1`, `Reparo2`, `Reparo3`, `Orcamento`, `DataSaida`, `Observacao`, `CodVeiculo`, `CodFornecedor`) VALUES
...
INSERT DELAYED IGNORE INTO `veiculo` (`Codigo`, `Placa`, `TipoVeiculo`, `Fabricacao`, `Modelo`, `Ano`, `renavam`, `Chassi`, `TipoPneu`, `TipoCombustivel`, `Tara`, `PesoLiquido`, `Observacao`) VALUES
