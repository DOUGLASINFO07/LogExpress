...
public class ConsultaFornecedor2 extends javax.swing.JFrame {

    public ConsultaFornecedor2() {
        initComponents();
    }
    ...
    Connection conn;
        ...
        ManutencaoPneus manutencaoPneus;
         ...
         public ConsultaFornecedor2(Connection conn, String Nome, String Fantasia, 
                 String CNPJ, String InscEstadual, String Telefone1, String Telefone2,
                 String Fax,  ManutencaoPneus manutencaoPneus) {
        initComponents();
    ...
    private void initComponents() {
        ...
        TConsultaFornecedor1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Nome Fantasia", "CNPJ ", "Inscrição Estadual", "Telefone1", "Telefone2", "Fax", "Codigo"
            }
        ));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(TFNomeFornecedor1, javax.swing.GroupLayout.PREFERRED_SIZE, 549, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void BSelecionarFornecedor1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BSelecionarFornecedor1ActionPerformed
        ...
        manutencaoPneus.TFNomeFornecedor2.setText(TConsultaFornecedor1.getValueAt(TConsultaFornecedor1.getSelectedRow(), 0).toString());
        manutencaoPneus.TFFantasiaFornecedor2.setText(TConsultaFornecedor1.getValueAt(TConsultaFornecedor1.getSelectedRow(), 1).toString());
        manutencaoPneus.TFCNPJFornecedor2.setText(TConsultaFornecedor1.getValueAt(TConsultaFornecedor1.getSelectedRow(), 2).toString());
        manutencaoPneus.TFInscEstadualFornecedor2.setText(TConsultaFornecedor1.getValueAt(TConsultaFornecedor1.getSelectedRow(), 3).toString());
        manutencaoPneus.TFTelefone1Fornecedor2.setText(TConsultaFornecedor1.getValueAt(TConsultaFornecedor1.getSelectedRow(), 4).toString());
        manutencaoPneus.TFTelefone2Fornecedor2.setText(TConsultaFornecedor1.getValueAt(TConsultaFornecedor1.getSelectedRow(), 5).toString());
        manutencaoPneus.TFFaxFornecedor2.setText(TConsultaFornecedor1.getValueAt(TConsultaFornecedor1.getSelectedRow(), 6).toString());
        manutencaoPneus.TFCodigoFornecedorPneus.setText(TConsultaFornecedor1.getValueAt(TConsultaFornecedor1.getSelectedRow(), 7).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaFornecedor2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaFornecedor2().setVisible(true);
            }
        });
    }
